...
const data = [
  {
    ...
    img2: "/agents/agents2.png",
    img3: "/agents/agents3.png",
    url: "https://investment-platform-mu.vercel.app/",
    tags: [
      "Python",
      "Google ADK",
      "Gemini",
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="pt-2 sm:pt-4">
                <button className="group/btn inline-flex items-center space-x-2 text-teal-400 hover:text-white font-semibold transition-colors duration-200 text-sm sm:text-base">
                  ...
                  <svg
                    className="w-3 h-3 sm:w-4 sm:h-4 transform group-hover/btn:translate-x-1 transition-transform duration-200"
                    fill="currentColor"
                    viewBox="0 0 24 24"
                  >
                    <path d="M13.22 19.03a.75.75 0 0 1 0-1.06L18.19 13H3.75a.75.75 0 0 1 0-1.5h14.44l-4.97-4.97a.75.75 0 0 1 1.06-1.06l6.25 6.25a.75.75 0 0 1 0 1.06l-6.25 6.25a.75.75 0 0 1-1.06 0z" />
      ...
      <div className="bg-slate-900/95 backdrop-blur-xl rounded-2xl sm:rounded-3xl border border-white/20 shadow-2xl max-w-4xl w-full max-h-[95vh] sm:max-h-[90vh]  overflow-hidden">
        ...
        <div className="flex justify-between items-start sm:items-center p-4 sm:p-6 border-b border-white/10">
          <div className="flex-1 pr-4">
            ...
            <h2 className="text-lg sm:text-2xl font-bold text-white mt-2 leading-tight">
              {project.title}
            </h2>
          </div>
          <button
        ...
        <div className="overflow-y-auto max-h-[calc(95vh-80px)] sm:max-h-[calc(90vh-80px)] pb-8">
          ...
          <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
            {project.url && (
              // make the url clickable and open in a new tab and when hover underline the url and color blue
              <div>
                ...
                <a
                  ...
                  className="text-gray-300 leading-relaxed text-sm sm:text-base hover:underline hover:text-blue-500"
                >
                  {project.url}
                </a>
              </div>
